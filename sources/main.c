...
/*
** Free the matrix of 3d points after it's used.
...
/*
** In this function, the file passed as argument is openned and the parsing
...
/*
** Main f-n calls the function that will start the plotting.
*/
